							  ...
							  const _GLFWfbconfig* fbconfig, void* parentWindowHandle)
{
	...
	// DAW-edit: We don't want this, it conflicts with win32's IDragDropTarget
...
GLFWAPI void glfwUpdateInternals(void)
{
	HWND handle;
	_GLFWwindow* window;
...
void _glfwPlatformSetCursorMode(_GLFWwindow* window, int mode)
{
    ...
    {
        if (window->isAlwaysFocused || _glfwPlatformWindowFocused(window))
            disableCursor(window);
    }
